package com.bierbobo.config.tool.codegen.service.impl;

import com.bierbobo.config.tool.codegen.service.GenerateService;
import com.bierbobo.config.tool.codegen.util.BundleUtils;
import com.bierbobo.tool.codegen.CodeGenPlugin;
import com.bierbobo.config.tool.codegen.domain.EntityMeta;
import com.bierbobo.config.tool.codegen.domain.FieldMeta;
  ...
  implements GenerateService
{
  ...
  public String generateDdl(String srcFolder, List<EntityMeta> entityMetaList)
  {
    ...
    for (EntityMeta entityMeta : entityMetaList) {
      ...
      List fieldMetaList = new ArrayList(entityMeta.getFieldMetaList());
  ...
  private FieldMeta createDefaultAutoSeqIdField()
  {
    FieldMeta autoSeqField = new FieldMeta();
    autoSeqField.setColumnName("auto_Seq_id");
    autoSeqField.setSqlType("bigint");

    autoSeqField.setJavaFieldName("autoSeqId");
    autoSeqField.setJavaType("Long");
    autoSeqField.setComment("系统自增长序列");
    autoSeqField.setTestValue("");

    autoSeqField.setAllowNull(false);
    autoSeqField.setPk(false);
    autoSeqField.setAutoIncrement(true);

    autoSeqField.setQuery(false);
    autoSeqField.setShowCols(false);
    autoSeqField.setFormItem(false);
  ...
  public void generateServiceTestClass(String srcFolder, EntityMeta entityMeta)
    throws IOException
  {
    generateFile(entityMeta, srcFolder, 
      "/service", "ServiceTest.java", "java/ServiceTest.java.vm");
  }
  ...
  public void generateI18n(String srcFolder, List<EntityMeta> entityMetaList)
    throws IOException
  {
    ...
    if (((EntityMeta)entityMetaList.get(0)).getProjectMeta().isI18n()) {
      generatePropertiesConfigFile(entityMetaList, fieldMetaMap, srcFolder, 
        "/i18n", "messages_en_US.properties", "i18n/i18n_messages_en_US.properties.vm");
      generatePropertiesConfigFile(entityMetaList, fieldMetaMap, srcFolder, 
        "/i18n", "messages_zh_CN.properties", "i18n/i18n_messages_zh_CN.properties.vm");
    }
  }
  ...
  public void generateExcelConstant(String srcFolder, List<EntityMeta> entityMetaList)
    throws IOException
  {
    String path = ((EntityMeta)entityMetaList.get(0)).getProjectMeta().getGroupId().replace(".", "/");
    generateConfigFile(entityMetaList, srcFolder, "/" + path + "/constant", "ExcelConstant.java", "java/ExcelConstant.java.vm");
  }

  public void generateMainController(String srcFolder, List<EntityMeta> entityMetaList)
    throws IOException
  {
    String path = ((EntityMeta)entityMetaList.get(0)).getProjectMeta().getGroupId().replace(".", "/");
    generateConfigFile(entityMetaList, srcFolder, "/" + path + "/main/controller", "MainController.java", "java/MainController.java.vm");
    generateConfigFile(entityMetaList, srcFolder, "/" + path + "/main/controller", "BaseController.java", "java/BaseController.java.vm");
  }

  public void generateVelocityPage(String srcFolder, EntityMeta entityMeta)
    throws IOException
  {
    if (entityMeta.getProjectMeta().isI18n()) {
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "List.vm", "web/i18n/list.vm.vm");
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "Edit.vm", "web/i18n/edit.vm.vm");
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "Detail.vm", "web/i18n/detail.vm.vm");
    } else {
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "List.vm", "web/list.vm.vm");
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "Edit.vm", "web/edit.vm.vm");
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "Detail.vm", "web/detail.vm.vm");
    }
  }

  public void generateVelocityDefaultPage(String srcFolder, EntityMeta entityMeta)
    throws IOException
  {
    if (entityMeta.getProjectMeta().isI18n()) {
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/", "main.vm", "web/i18n/main.vm.vm");
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/layout", "default.vm", "web/i18n/default.vm.vm");
    } else {
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/", "main.vm", "web/main.vm.vm");
      generateConfigFile(entityMeta, srcFolder, 
        "/WEB-INF/vm/layout", "default.vm", "web/default.vm.vm");
    }
  }

  public void generateJavaScript(String srcFolder, EntityMeta entityMeta)
    throws IOException
  {
    if (entityMeta.getProjectMeta().isI18n()) {
      generateConfigFile(entityMeta, srcFolder, "/static/script/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "Edit.js", "script/i18n/edit.js.vm");
      generateConfigFile(entityMeta, srcFolder, "/static/script/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "List.js", "script/i18n/list.js.vm");
    } else {
      generateConfigFile(entityMeta, srcFolder, "/static/script/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "Edit.js", "script/edit.js.vm");
      generateConfigFile(entityMeta, srcFolder, "/static/script/" + entityMeta.getLowerClassName(), entityMeta.getLowerClassName() + "List.js", "script/list.js.vm");
    }
  }

  public void generateJavaScriptCommonFn(String srcFolder, EntityMeta entityMeta)
    throws IOException
  {
    if (entityMeta.getProjectMeta().isI18n())
      generateConfigFile(entityMeta, srcFolder, "/static/js/util/", "jquery.fn.extend.js", "script/i18n/jquery.fn.extend.js.vm");
    else
      generateConfigFile(entityMeta, srcFolder, "/static/js/util/", "jquery.fn.extend.js", "script/jquery.fn.extend.js.vm");
  }
  ...
  private void generateConfigFile(Set entityMetaSet, String srcFolder, String packageSuffix, String fileName, String templatePath)
    throws IOException
  {
    FileOutputStream os = null;
    try {
      ...
      Writer writer = new OutputStreamWriter(os, Charset.forName("UTF-8"));
      Map map = new HashMap();
      map.put("entityMetaSet", entityMetaSet);
      execute(templatePath, map, writer);
      writer.flush();
    } finally {
      IOUtils.closeQuietly(os);
